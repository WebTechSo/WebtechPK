      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-5 py-14 md:grid-cols-[1.3fr_1fr_1fr] md:px-8">
        <div>
          ...
          <p className="mt-4 max-w-sm text-sm leading-relaxed text-white/70">
            {company.tagline}. We help growing companies modernize systems,
            ship AI into real workflows, and build software that compounds.
          </p>
          <p className="mt-5 text-sm text-white/55">{company.location}</p>
        </div>
